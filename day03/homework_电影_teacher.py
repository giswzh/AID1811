...
class movieSpider(object):
    ...
    def parse_info(self,html):
        ...
        film_list = parse_html.xpath('//dl[@class="board-wrapper"]//dd')
        for i in film_list:
            c1 = i.xpath("./a/@title")[0].strip()
            c2 = i.xpath(".//p[@class='star']/text()")[0].strip()
            c3 = i.xpath(".//p[@class='releasetime']/text()")[0].strip()
            print (c1,c2,c3)
            print("*"*40)
            r_list = [c1, c2, c3]
